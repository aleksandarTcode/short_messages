                            ...
                            <div class="e-profile">
                                <div class="row">
                                    <div class="col-12 col-sm-auto mb-3">
                                        <div class="col-md-6">
                                            <img src="img/profile_photos/<?php echo $user->user_photo; ?>" style='float: left; width: 200px; height: 200px; object-fit: cover;' alt="profile picture" class="d-none d-md-block">
                                        </div>
                                    </div>
